...
USER_INFO_THEME_PROMPT_COLOR=${POWERLINE_USER_INFO_COLOR:=64}
...
HOST_THEME_PROMPT_COLOR=${POWERLINE_HOST_COLOR:=66}
...
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="in_vim clock battery user_info hostname"}
